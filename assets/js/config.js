...
window.SCHOOL = {
  ...
  font:    'roboto',
  layout:  'layout0',
  modules: ["students","staff","classes","subjects","attendance","results","flyer","report-cards","analytics","admin-data","approvals","timetable-generator","checkin","diary","surveys","menu","settings","fees","timetable","cbt","sow","messages","announcements","events","gallery","library","digital_library","assignments","parents","idcards","directory","departments","broadcast","complaints","leave","visitors","conduct","health","promotion","lms","gamification","career_counseling","lesson_plans","behaviour","support_plans","substitutions","admissions","hr","alumni","hostel","inventory","certificates","document_builder","fleet_tracking","facility_booking","compliance","activity_log","inbox","voting","parent_meeting","front_desk","helpdesk","birthdays","eresources","reports","school_calendar","lost_found","book_request","finance","transport","cafeteria","financial_aid","donations","payments_online"],
